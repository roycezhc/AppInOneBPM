...
function SelectAll(mod,parmod)
{
	...
	//{
			...
			{
					document.location.href="index.php?module="+module+"&parentid="+entity_id+"&action=updateRelations&destination_module="+mod+"&idlist="+idstring;
			}
			//self.close();
	//}
	//else
...
function SelectUser(field){
	...
	window.open('index.php?module=Users&action=PopupSelectUser'+urlstring,'test3123123','width=600,height=400,resizable=1,scrollbars=1');
}
...
function duplicateView(setype,category) {
	var viewid = $('viewname').value;
	var url = "index.php?module=" + setype +"&action=CustomView&isDuplicate=true&record=" + viewid +"&parenttab="+category;
	window.location.href = url;
}
/**
 * Drag to adjust view
...
Jquery("#" + objid + "_info_div").html(resulthtml); alert(15);
		},error:function(){
			//alert('Null');
		}
	});
...
Jquery("#" + objid + "_info_div").html(resulthtml); alert(14);
	}
}
...
function SearchViewScope(modulename,objid,sectuserid,obj){
	...
	if(Jquery("#"+objid+"_bind_div") && Jquery("#"+objid+"_bind_div").html() != ''){
		...
		resulthtml += '<div class="smowner-scope-div" onmouseover="this.className=\'smowner-scope-over\';" '+
							...
							'\''+viewname+'\',\''+modulename+'\');"'+
							'style="color:'+color+'">'+scopreObj.share_of_me.value+'</div>';
		Jquery("#" + objid + "_info_div").html(resulthtml); alert(133);
	}
}
...
Jquery("#" + objid + "_info_div").html(resulthtml); alert(122);
		},error:function(){
			//alert('Null');
		}
	});
...
Jquery("#" + objid + "_info_div").html(resulthtml); alert(11);
	}
}
...
function setSmownerAllUserOpts(objid,sectuserid){
    Jquery.ajax({
        ...
        success: function (rest) {
            ...
            Jquery("#" + objid + "_info_div").html(resulthtml); alert(1);
        }, error: function () {
            //alert('Null');
        }
    });
