<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="SYS_BILLEditTB" CodeFile="BILLEditTB.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 ...
 <script type="text/javascript">
       ...
       var sysTbNameExt = "<%=txtTABLE_NAME_PRE.Value %>";
       function tableTypeChange(me, b) {
           var syst = $("input[id$='radSysTable']")[0];
           var clientt = $("input[id$='radClientTable']")[0];
           var pre = $("input[id$='txtTABLE_NAME_PRE']");
           if (syst.checked) {
               pre[0].readOnly = false;
               if (b) {
                   pre.val(sysTbNameExt);
               }
           }
           else {
               pre[0].readOnly = true;
               if (b) {
                   sysTbNameExt = pre.val();
                   pre.val("U_");
               }
           }
       }
...
<div class="form" id="divForm">
       <div>
           ...
           <dl>
           <dt>&nbsp;</dt><dd>
           <input style=" border:none; width:20px;" id="radSysTable" runat="server" type="radio" name="RadTableType" checked="true" onclick="tableTypeChange(this, true);"/><label for="<%=radSysTable.ClientID %>">系统表</label>
           &nbsp;&nbsp;
           <input style=" border:none; width:20px;" id="radClientTable" runat="server" type="radio" name="RadTableType" onclick="tableTypeChange(this, true);"/><label for="<%=radSysTable.ClientID %>">客户表</label>
           </dd>
           </dl>
           <dl>
