<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="SYS_BILL_COLEditTB" CodeFile="COLEditTB.aspx.cs" %>
       ...
       <div>
          ...
          <dl>
           ...
           <dl>
               <dt></dt>
               <dd><span>
                     <a style="color:Red;">以"U_"开头将被设置为客户字段</a>
                    </span>
               </dd>
           </dl>
         ...
         <%--  </div>
           ...
           <dl>
               <dt>在此字段上建立树结构：</dt><%--SORT_NO--%>
               <dd><span>
                    <input style=" border:none; width:18px;" id="chkBuildTree" type="checkbox" checked="false" runat="server"/>
                   </span>
               </dd>
           </dl>
           </div>
