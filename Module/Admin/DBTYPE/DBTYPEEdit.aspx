<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="WF_FIELD_DBTYPEEdit2" CodeFile="DBTYPEEdit.aspx.cs" %>
       ...
       <div>
           ...
           <dl>
               ...
               <dd><span>
                    ...
                    <input id="txtTYPE_ID" type="text" runat="server" ck="{need:1,len:2147483647,type:1}"/></span>
               </dd>
           </dl>
           <dl>
               ...
               <dd><span>
                    ...
                    <input id="txtTYPE_NAME" type="text" runat="server" ck="{need:0,len:50,type:0}"/></span>
               </dd>
           </dl>
           <dl>
               ...
               <dd><span>
                    ...
                    <input id="txtDB_TYPE" type="text" runat="server" ck="{need:0,len:50,type:0}"/></span>
               </dd>
           </dl>
           <dl>
               ...
               <dd><span>
                    ...
                    <textarea id="txtCTRL_TYPES" cols="1" rows="1" style="height:80px;width:400px;overflow:hidden;" 
