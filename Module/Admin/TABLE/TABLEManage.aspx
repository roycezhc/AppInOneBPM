...
<div class="main">
   ...
   <div class="topfind" style="display:none;"><!--topfind -- 需要隐去时，用 style="display:none;"-->        
        ...
        <div class="tool">--%>
         <dl><dt></dt><dd class="btn">
                <span><asp:Button ID="btnFind" Text="查询" runat="server" onclick="btnFind_Click" /></span>
         ...
         <table cellpadding="0" cellspacing="0" id="tbList">
            <thead>
                <tr keyname="TB_ID">
                    ...
                    <td runat="server" id="head_TB_ID" data="{colname:'<%=TF_TABLE.Attribute.TB_ID.LongName%>',show:1}"><%=TF_TABLE.Attribute.TB_ID._ZhName %></td><!--表ID-->
            ...
            <tbody>
                ...
                <ItemTemplate>
                  <asp:Label ID="lid" runat="server" Text='<%#Eval("TB_ID") %>' Visible="false"></asp:Label>
               <tr>
                    <td class="first"><input type="checkbox" value="<%#((TF_TABLE)Container.DataItem).TB_ID%>" /></td>

                      <asp:Repeater ID="repx" runat="server">
                          <ItemTemplate>
                             <li><a href="product.aspx?id=<%# Eval("TB_ID")%>&cid=<%# Eval("TB_ID")%>" <%--<%#getover2(Container.ItemIndex+1,Eval("TB_ID").ToString()) %>--%>>◆ 111 <%--<%#Cut.Cut_title2(Eval("Title").ToString(),20)%>--%></a></li>
                         </ItemTemplate>
                      </asp:Repeater>                     
                </tr>
                <tr>
                    ...
                    <td runat="server" id="TB_ID"><%#((TF_TABLE)Container.DataItem).TB_ID %></td>
