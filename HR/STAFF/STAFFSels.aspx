    ...
    <div class="warn"><asp:Literal ID="litWarn" runat="server"></asp:Literal></div>
     <div class="topfind"> 
          ...
          <dl class="btn"><dd>
               ...
               <span><input id="btnSelOK" type="button" onclick="selsok();" value="确定选择" /></span>
               </dd>
        </dl>
        <div class="clear"></div>
    </div> 
       ...
       <table cellpadding="0" cellspacing="0">
            ...
            <tbody>
                 <asp:Repeater ID="repList" runat="server" onitemdatabound="repList_ItemDataBound">
                    <ItemTemplate>
                    <tr>
                    <td class="first"><input id="chkSel" type="checkbox" runat="server" onclick="selsThis(this);" value="<%#((HR_STAFF)Container.DataItem).STAFF_ID %>" /></td>
