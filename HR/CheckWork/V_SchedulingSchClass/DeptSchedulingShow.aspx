<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="HR_CheckWork_DeptSchedulingShow" CodeFile="DeptSchedulingShow.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function editSch() {
            var editurl = 'DeptV_SchedulingManage.aspx?r=' + Math.random();
