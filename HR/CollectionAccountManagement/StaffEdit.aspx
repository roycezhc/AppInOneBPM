<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="HR_CollectionAccountManagement_STAFFEdit2" CodeFile="STAFFEdit.aspx.cs" %>
...
<div class="main">
  ...
  <div class="tabs">
         <ul><li class="show"><a>基本信息</a></li><li><a>详细信息</a></li><li><a>账户信息</a></li><asp:Literal ID="litTabName" runat="server"></asp:Literal></ul>
         <ol>
            <li class="show"><input id="txtSTAFF_ID" type="hidden" runat="server"/>
               <div class="form">
           <dl>
           ...
           <dl>
               ...
               <dd>
                    ...
                    <span><input id="txtUSER_NAME1" type="text" readonly="readonly" runat="server" ck="{need:0,len:20,type:0}"/></span>
