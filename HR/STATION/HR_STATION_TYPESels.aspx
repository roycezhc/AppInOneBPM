<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="HR_STATION_TYPESels.aspx.cs" Inherits="HR_STATION_TYPESels" %>
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=HR_STATION_TYPE.Attribute.TYPE_ID._ZhName %><!--岗位类型ID--></td>
                    
                    
                    <td><%=HR_STATION_TYPE.Attribute.TYPE_NAME._ZhName %><!--岗位类型名称--></td>
                    
                    
                    <td><%=HR_STATION_TYPE.Attribute.ADDTIME._ZhName %><!--添加时间--></td>
                </tr>
            </thead>
            <tbody>
