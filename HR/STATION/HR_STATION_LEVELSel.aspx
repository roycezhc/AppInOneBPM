<%@ Page Title="用户选择" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="HR_STATION_LEVELSel.aspx.cs" Inherits="HR_STATION_LEVELSel" %>
          ...
          <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><%=HR_STATION_LEVEL.Attribute.LEVEL_ID._ZhName %></td><!--岗位等级ID-->
                    
                    
                    <td><%=HR_STATION_LEVEL.Attribute.LEVEL_NAME._ZhName %></td><!--岗位等级名称-->
                    
                    
                    <td><%=HR_STATION_LEVEL.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
                </tr>
            </thead>
