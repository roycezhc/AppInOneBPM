<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="HR_STATION_LEVELEdit.aspx.cs" Inherits="HR_STATION_LEVELEdit" %>
...
<div class="form" id="divForm">
       <div>
           ...
           <dl>
               ...
               <dd><span>
               <!--文字-->
                    <input id="txtLEVEL_ID" type="text" runat="server" ck="{type:1,min:0,max:8,need:0}"/></span>
               </dd>
           </dl>
           <dl>
               ...
               <dd><span>
               <!--文字-->
                    <input id="txtLEVEL_NAME" type="text" runat="server" ck="{type:0,min:0,max:50,need:1}"/></span>
               </dd>
           </dl>
           <dl>
