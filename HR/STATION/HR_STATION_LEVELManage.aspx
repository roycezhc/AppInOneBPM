...
<div class="main">
   ...
   <div class="topfind"><!--需要隐去时，用 style="display:none;"-->        
    ...
    <div class="tool">
        <ul>
            <li><span><input power="newHR_STATION_LEVEL" id="btn_New" type="button" value="新建" onclick="manager.newRecord('HR_STATION_LEVELEdit.aspx');" /></span></li>
            <li><span><input power="editHR_STATION_LEVEL" id="btn_Edit" type="button" value="编辑" onclick="manager.editRecord('HR_STATION_LEVELEdit.aspx');" /></span></li>
<%--            <li><span class="btn"><input power="newHR_STATION_LEVEL" id="btn_NewSub" type="button" value="新建下级" onclick="manager.newRecord('STORAGEEdit.aspx','PID');" /></span></li>--%>
            <li><span><input id="btn_Dels" type="button" value="删除" onclick="manager.delBySelIDS('HR_STATION_LEVELBack.aspx');" /></span></li>
        </ul>
        <ol>
            <li><b>每页显示</b></li>
            ...
            <thead>
                <tr keyname="LEVEL_ID">
                   ...
                   <%-- <td><a href="Manage.aspx" id="a_top" runat="server"><b>顶级</b></a></td>--%>
                    ...
                    <td data="{colname:'<%=HR_STATION_LEVEL.Attribute.LEVEL_ID.LongName%>',show:1}"><%=HR_STATION_LEVEL.Attribute.LEVEL_ID._ZhName %></td><!--岗位等级ID-->
                    
                    
                    <td data="{colname:'<%=HR_STATION_LEVEL.Attribute.LEVEL_NAME.LongName%>',show:1}"><%=HR_STATION_LEVEL.Attribute.LEVEL_NAME._ZhName %></td><!--岗位等级名称-->
                    
                    
                    <td data="{colname:'<%=HR_STATION_LEVEL.Attribute.ADDTIME.LongName%>',show:1}"><%=HR_STATION_LEVEL.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
            </tr>
            </tbody>
            <tbody>
