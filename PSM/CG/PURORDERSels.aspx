<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="IM_PURORDERSels" CodeFile="PURORDERSels.aspx.cs" %>
 ...
 <div class="main">
    ...
    <div class="warn"><asp:Literal ID="litWarn" runat="server"></asp:Literal></div>
     <div class="topfind">
        ...
        <span><input id="btnSelOK" type="button" value="<%=LanguageService.GetLanguageString("SureChoose", "确定选择") %>" onclick="selok();" /></span>
        <span><input type="button" id="btnClear" value="<%=LanguageService.GetLanguageString("Clear", "清空") %>" /></span>
        </dd></dl>
        <div class="clear"></div>
    </div>    
    <div class="lrlayout">
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=IM_PURORDER.Attribute.PORD_NO._ZhName %><!--单据编号--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.C_DATE._ZhName %><!--单据日期--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.ORG_ID._ZhName %><!--机构ID--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.DEPT_ID._ZhName %><!--部门ID--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.SUP_ID._ZhName %><!--供应商ID--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.PERSON_HID._ZhName %><!--经手人ID--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.TS_NO._ZhName %><!--运单号--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.GOODES_NUM._ZhName %><!--货物数量--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.ARRIVAL_DATE._ZhName %><!--到货日期--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.PACKAGE_TYPE._ZhName %><!--包装方式--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.TS_DEPT._ZhName %><!--承运单位--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.PHONE._ZhName %><!--电话--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.COST_PEICE_FLAG._ZhName %><!--成本价采购--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.STOR_ID._ZhName %><!--STOR_ID--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.DEDUCTION_RATE._ZhName %><!--扣率--></td>
                    ...
                    <td><%=IM_PURORDER.Attribute.NOTE._ZhName %><!--备注--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.REMARK._ZhName %><!--摘要--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.EXP1._ZhName %><!--自定义1--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.EXP2._ZhName %><!--自定义2--></td>
                    
                    
                    <td><%=IM_PURORDER.Attribute.EXP3._ZhName %><!--自定义3--></td>
                </tr>
            </thead>
            <tbody>
