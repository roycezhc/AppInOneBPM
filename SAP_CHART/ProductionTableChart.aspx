<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SAP_CHART/SAPCHARTBLANK.master" CodeFile="ProductionTableChart.aspx.cs" Inherits="SAP_CHART_Production" %>
            ...
            <thead>
                <tr>
                    ...
                    <% foreach(ITableImplement val in valList ) {
                           ...
                           %>
                        <th width="<%=index==2||index==3||index==4?"100":"50" %>"><%=Convert.ToString(val["ZDATE"]).Substring(5,2)+"/"+Convert.ToString(val["ZDATE"]).Substring(8,2)%></th>
                    <%} %>
                </tr>
            </thead>
            <tbody>
