...
public partial class WECWebsite_List_List3 : System.Web.UI.UserControl
{
    ...
    {
        List<WEC_CUSTOM_Article> list2=new List<WEC_CUSTOM_Article>();
        ...
        cond.OrderBy(WEC_CUSTOM_Article.Attribute.CID);
        list2 = BLLTable<WEC_CUSTOM_Article>.Select(new WEC_CUSTOM_Article(), cond);
        foreach (WEC_CUSTOM_Article we in list2)
        {
