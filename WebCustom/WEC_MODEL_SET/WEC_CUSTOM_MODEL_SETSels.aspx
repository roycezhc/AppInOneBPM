<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CUSTOM_MODEL_SETSels.aspx.cs" Inherits="WEC_CUSTOM_MODEL_SETSels" %>
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=WEC_CUSTOM_MODEL_SET.Attribute.ID._ZhName %><!--编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL_SET.Attribute.A_ID._ZhName %><!--公众号编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL_SET.Attribute.M_ID._ZhName %><!--模版编号--></td>
                </tr>
            </thead>
            <tbody>
                 <asp:Repeater ID="repList" runat="server" onitemdatabound="repList_ItemDataBound">
                    <ItemTemplate>
                     <tr>
                     <td><input id="chkSel" type="checkbox" runat="server" onclick="selThis(this);" value="<%#((WEC_CUSTOM_MODEL_SET)Container.DataItem).ID %>" /></td>
