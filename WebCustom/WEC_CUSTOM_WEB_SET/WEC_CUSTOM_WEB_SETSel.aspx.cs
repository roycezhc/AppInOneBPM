...
public partial class WEC_CUSTOM_WEB_SETSel : BaseAdminPage
{
    protected string showLeftLinks(string path, string pname)
    {
        ...
        if (litPathLink.Text == "")
        {
            litPathLink.Text = CommonHelper.GetPathLinks("WEC_CUSTOM_WEB_SETSel.aspx", pid, path, pname);
        }
        return CommonHelper.ShowLinkByPath("WEC_CUSTOM_WEB_SETSel.aspx", path);
    }
    ...
    protected void aspPager_PageChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            listObj = BLLTable<WEC_CUSTOM_WEB_SET>.Factory(conn).SelectByPage(valObj, condObj, aspPager.PageSize, aspPager.CurrentPageIndex, ref recount);
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        //WEC_CUSTOM_WEB_SET valObj = BLLTable<WEC_CUSTOM_WEB_SET>.Factory(conn).GetRowData(WEC_CUSTOM_WEB_SET.Attribute.ID, pid);
        //litPathLink.Text = CommonHelper.GetPathLinks("WEC_CUSTOM_WEB_SETSel.aspx", pid, valObj.PATH, valObj.PNAME);
        //a_top.Visible = true;
