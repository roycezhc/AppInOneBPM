<%@ Page Title="用户选择" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CUSTOM_WEB_SETSel.aspx.cs" Inherits="WEC_CUSTOM_WEB_SETSel" %>
          ...
          <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><%=WEC_CUSTOM_WEB_SET.Attribute.ID._ZhName %></td><!--编号-->
                    
                    
                    <td><%=WEC_CUSTOM_WEB_SET.Attribute.STAFF_ID._ZhName %></td><!--用户编号-->
                    
                    
                    <td><%=WEC_CUSTOM_WEB_SET.Attribute.A_ID._ZhName %></td><!--网站编号-->
                </tr>
            </thead>
