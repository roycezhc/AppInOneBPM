<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CUSTOM_MODELSels.aspx.cs" Inherits="WEC_CUSTOM_MODELSels" %>
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=WEC_CUSTOM_MODEL.Attribute.ID._ZhName %><!--编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.TYPE._ZhName %><!--类型--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.PIC_URL._ZhName %><!--图片地址--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.PATH._ZhName %><!--模版路径--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.ADDTIME._ZhName %><!--添加时间--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.STATUS._ZhName %><!--状态--></td>
                    
                    
                    <td><%=WEC_CUSTOM_MODEL.Attribute.NAME._ZhName %><!--标题--></td>
                </tr>
            </thead>
            <tbody>
                 <asp:Repeater ID="repList" runat="server" onitemdatabound="repList_ItemDataBound">
                    <ItemTemplate>
                     <tr>
                     <td><input id="chkSel" type="checkbox" runat="server" onclick="selThis(this);" value="<%#((WEC_CUSTOM_MODEL)Container.DataItem).ID %>" /></td>
                     
                    
                    <td><%#((WEC_CUSTOM_MODEL)Container.DataItem).ID %></td>
                    
                    
                    <td><%#formhelper.GetOptionText(WEC_CUSTOM_MODEL.Attribute.TYPE, ((WEC_CUSTOM_MODEL)Container.DataItem).TYPE)%></td>
                    ...
                    <td><%#((WEC_CUSTOM_MODEL)Container.DataItem).ADDTIME.ToString("yyyy-MM-dd HH:mm") %></td>
                    
                    
                    <td><%#formhelper.GetOptionText(WEC_CUSTOM_MODEL.Attribute.STATUS, ((WEC_CUSTOM_MODEL)Container.DataItem).STATUS)%></td>
