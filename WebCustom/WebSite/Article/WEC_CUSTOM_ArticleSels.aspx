<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CUSTOM_ArticleSels.aspx.cs" Inherits="WEC_CUSTOM_ArticleSels" %>
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=WEC_CUSTOM_Article.Attribute.ID._ZhName %><!--编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.CID._ZhName %><!--栏目编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.AID._ZhName %><!--公众号编号--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.TITLE._ZhName %><!--标题--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.DES._ZhName %><!--描述--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.CONTENT._ZhName %><!--内容--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.URL._ZhName %><!--外链地址--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.PIC_URL._ZhName %><!--图片地址--></td>
                    
                    
                    <td><%=WEC_CUSTOM_Article.Attribute.MODEL_ID._ZhName %><!--模版编号--></td>
                </tr>
            </thead>
            <tbody>
                 <asp:Repeater ID="repList" runat="server" onitemdatabound="repList_ItemDataBound">
                    <ItemTemplate>
                     <tr>
                     <td><input id="chkSel" type="checkbox" runat="server" onclick="selThis(this);" value="<%#((WEC_CUSTOM_Article)Container.DataItem).ID %>" /></td>
                    ...
                    <td><%#((WEC_CUSTOM_Article)Container.DataItem).CONTENT %></td>
                    
                    
                    <td><%#((WEC_CUSTOM_Article)Container.DataItem).URL %></td>
                    
                    
                    <td><%#((WEC_CUSTOM_Article)Container.DataItem).PIC_URL %></td>
