<%@ Page Title="" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="SiteColumnTree.aspx.cs" Inherits="Admin_WebSite_SiteColumn_SiteColumnTree" %>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        CT.magParam.editUrl = "SiteColumnEdit.aspx";
        CT.magParam.manageUrl = "SiteColumnManage.aspx";
        CT.magParam.backSvrUrl = "SiteColumnBack.aspx";
        CT.magParam.showUrl = "SiteColumnShow.aspx";
        CT.magParam.defaultUrl = "../Article/WEC_CUSTOM_ArticleManage.aspx";
