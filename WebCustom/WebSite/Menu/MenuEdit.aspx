...
<div class="form" id="divForm">
       <div>
           ...
           <dl class="hide">
               <dt><%=WEC_CUSTOM_MENU.Attribute.ID.ZhName %>：</dt><%--编号--%>
               <dd><span>
               <!--文字-->
           ...
           <dl  class="hide">
               <dt><%=WEC_CUSTOM_MENU.Attribute.PID.ZhName %>：</dt><%--父编号--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_CUSTOM_MENU.Attribute.MENU_NAME.ZhName %>：</dt><%--菜单名称--%>
               <dd><span>
               <!--文字-->
           ...
           <dl  class="hide">
               <dt><%=WEC_CUSTOM_MENU.Attribute.AID.ZhName %>：</dt><%--公众号ID--%>
               <dd><span>
               <!--文字-->
           ...
           <dl >
               <dt><%=WEC_CUSTOM_MENU.Attribute.MENU_TYPE.ZhName %>：</dt><%--菜单TYPE--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_CUSTOM_MENU.Attribute.SORT_ID.ZhName %>：</dt><%--排序--%>
               <dd><span>
               <!--文字-->
            ...
            <dl>
               <dt><%=WEC_CUSTOM_MENU.Attribute.STATUS.ZhName %>：</dt><%--状态--%>
               <dd><span>
