...
public partial class WEC_CUSTOM_CATEBANNERShow : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            try
            {
                if (!string.IsNullOrEmpty(Request["ID"]))
                {
                    ...
                    valObj = BLLTable<WEC_CUSTOM_CATEBANNER>.GetRowData(WEC_CUSTOM_CATEBANNER.Attribute.ID, Request["ID"]);
