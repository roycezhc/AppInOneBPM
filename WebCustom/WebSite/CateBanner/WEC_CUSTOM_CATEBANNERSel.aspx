<%@ Page Title="用户选择" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CUSTOM_CATEBANNERSel.aspx.cs" Inherits="WEC_CUSTOM_CATEBANNERSel" %>
          ...
          <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.ID._ZhName %></td><!--编号-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.AID._ZhName %></td><!--公众号编号-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.PIC_URL._ZhName %></td><!--图片地址-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.OUT_URL._ZhName %></td><!--链接地址-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.SORT_ID._ZhName %></td><!--排序-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.STATUS._ZhName %></td><!--状态-->
                    
                    
                    <td><%=WEC_CUSTOM_CATEBANNER.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
                </tr>
            </thead>
