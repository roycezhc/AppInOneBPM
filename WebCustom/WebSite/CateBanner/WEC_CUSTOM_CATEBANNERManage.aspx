...
<div class="main">
   ...
   <div class="topfind hide"><!--需要隐去时，用 style="display:none;"-->        
    ...
    <div class="tool">
        <ul>
            <li><span><input power="newWEC_CUSTOM_CATEBANNER" id="btn_New" type="button" value="新建" onclick="manager.newRecord('WEC_CUSTOM_CATEBANNEREdit.aspx?aid=<%=aid%>','','1',900,700);" /></span></li>
            <li><span><input power="editWEC_CUSTOM_CATEBANNER" id="btn_Edit" type="button" value="编辑" onclick="manager.editRecord('WEC_CUSTOM_CATEBANNEREdit.aspx?aid=<%=aid%>','','1',900,700);" /></span></li>
<%--            <li><span class="btn"><input power="newWEC_CUSTOM_CATEBANNER" id="btn_NewSub" type="button" value="新建下级" onclick="manager.newRecord('STORAGEEdit.aspx','PID');" /></span></li>--%>
            <li><span><input id="btn_Dels" type="button" value="删除" onclick="manager.delBySelIDS('WEC_CUSTOM_CATEBANNERBack.aspx?aid=<%=aid%>');" /></span></li>
         ...
         <table cellpadding="0" cellspacing="0" id="tbList">
            <thead>
                <tr keyname="ID">
                   ...
                   <%-- <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.ID.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.ID._ZhName %></td><!--编号-->
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.AID.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.AID._ZhName %></td><!--公众号编号-->--%>
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.PIC_URL.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.PIC_URL._ZhName %></td><!--图片地址-->
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.OUT_URL.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.OUT_URL._ZhName %></td><!--链接地址-->
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.SORT_ID.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.SORT_ID._ZhName %></td><!--排序-->
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.STATUS.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.STATUS._ZhName %></td><!--状态-->
                    
                    
                    <td data="{colname:'<%=WEC_CUSTOM_CATEBANNER.Attribute.ADDTIME.LongName%>',show:1}"><%=WEC_CUSTOM_CATEBANNER.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
            </tr>
            </tbody>
            <tbody>
