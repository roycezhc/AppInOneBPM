<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="SYS_RoleUsers" CodeFile="RoleUsers.aspx.cs" %>
...
<div class="main">
   <div class="titnav">
    <dl><dt><b><%=title %></b></dt><dd><a href="<%=preUrl %>">返回</a></dd></dl>
   </div>
   ...
   <div class="topfind">
    ...
    <div class="tool">
        <ul>
           <%-- <li><span><input power="NewUser" id="btn_New" type="button" value="新建" onclick="manager.newRecord('../User/USEREdit.aspx');" /></span></li>
            <li><span><input power="EditUser" id="btn_Edit" type="button" value="编辑" onclick="manager.editRecord('../User/USEREdit.aspx');" /></span></li>--%>
            <li><span><input power="DeleteSels" id="btn_Dels" type="button" value="删除" onclick="manager.delBySelIDS('../User/USERBack.aspx');" /></span></li>
        </ul>
        <ol>
        </ol>
    </div>
