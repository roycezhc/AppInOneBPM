<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="SYS_USERDATAEdit" CodeFile="SYS_USERDATAEdit.aspx.cs" %>
...
<div class="main">
   ...
   <div class="warn"><asp:Literal ID="litWarn" runat="server"></asp:Literal></div>
    <div class="form" id="divForm">
       ...
       <div>
           ...
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtUSER_ID" type="text" runat="server" ck="{need:1,len:2147483647,type:1}"/>
               </dd>
           </dl>
           <dl>
       ...
       <div class="hide">
         <iframe name="ifrReal" id="ifrReal" src="SYS_USERDATAReal.aspx" frameborder="0" scrolling="auto" style="width:100%;"></iframe>
       </div>
