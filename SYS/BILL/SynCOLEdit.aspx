...
//         setDisabled($("input[id$='txtDVAL']"));
     ...
     function selTableField(me) {
         ...
         var result = window.showModalDialog("TableFieldSel_DEV.aspx?DEV=" + devObj.val() + "&TB=" + tbname + "&modlg=" + Math.random(), "newwindow", "dialogHeight=600px; dialogWidth=700px;dialogLeft:;dialogTop:; status=No;");if (!result) {result = window.returnValue;}//jin-shenjian chrome刷新父画面
...
<div class="form" id="divForm">
       <div>
           ...
           <div>
           <dl>
               <dt title="此字段用于保存同步其他系统库某表的字段信息">数据源：</dt>
          ...
          <dl>
           ...
           <dl>
               ...
               <dd><span>
                     ...
                     <input id="btnSelCol" type="button" value="" class="sel" title="选择关联表字段" onclick="selTableField(this);" />
                    </span>
               </dd>
           </dl>
           <dl>
            ...
            <dl>
                   ...
                   <dd><span>
                       <select id="txtIS_AUTO" runat="server" showtypes="int,bigint,decimal,numeric">
                           <option value="0">非递增</option><option value="1">递增</option>
                       </select></span>
                   </dd>
               </dl>
               <dl>
                   ...
                   <dd><span>
                       <select id="txtISPK" runat="server" onchange="ISPK_CHG(this);">
                           <option value="0">非主键</option><option value="1">主键</option>
                       </select></span>
                   </dd>
               </dl>
