...
public partial class SYS_BILL_COLFormEdit : AgileFrame.AppInOne.Common.BaseAdminPage
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        if (count > 0)
        {
            ...
            if (Request["tree"] != null)
            {
                ...
                string name = valObj.DISPLAY_NAME;
                if (string.IsNullOrEmpty(name))
                {
                    name = valObj.COL_NOTE;
                }
                if (string.IsNullOrEmpty(name))
                {
                    name = valObj.COL_NAME;
                }
                sb.Append(name).Append("',ntype:'col'}");
            ...
            else
            {
                ...
                if (btn.ID.IndexOf("btnOK") != -1)
                {
                    ...
                    string dataStr = "(" + sbData.ToString() + ")";
