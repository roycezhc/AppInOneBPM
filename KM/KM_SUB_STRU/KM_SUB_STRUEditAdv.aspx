<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="KM_SUB_STRUEditAdv" CodeFile="KM_SUB_STRUEditAdv.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" Runat="Server">
    <input id="hidKey" type="hidden" value="<%=valObj.SUB_ID %>" />
<div class="main">
   <div class="titnav">
