<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="KM_PART_STRUEdit" CodeFile="KM_PART_STRUEdit.aspx.cs" %>
...
<div class="main">
   ...
   <div class="warn"><asp:Literal ID="litWarn" runat="server"></asp:Literal></div>
    <div class="form" id="divForm">
       ...
       <div>
           ...
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtPART_NAME" type="text" runat="server" ck="{need:0,len:50,type:0}"/>
               </dd>
           </dl>
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtK_PART_ID" type="text" runat="server" ck="{need:0,len:50,type:0}"/>
               </dd>
           </dl>
           <dl>
               ...
               <dd>
                    ...
                    <textarea id="txtPART_CONTENT" cols="1" rows="1" style="height:80px;width:400px;overflow:hidden;" 
           ...
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtPART_CLASS_ID" type="text" runat="server" ck="{need:0,len:10,type:0}"/>
               </dd>
           </dl>
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtPART_EA_SIGN" type="text" runat="server" ck="{need:0,len:10,type:0}"/>
               </dd>
           </dl>
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtPART_AUTHOR" type="text" runat="server" ck="{need:0,len:50,type:0}"/>
               </dd>
           </dl>
           <dl>
               ...
               <dd>
                    ...
                    <input id="txtPART_IS_READ" type="text" runat="server" ck="{need:0,len:10,type:0}"/>
               </dd>
           </dl>
           <dl>
       ...
       <div class="hide">
         <iframe name="ifrReal" id="ifrReal" src="KM_PART_STRUReal.aspx" frameborder="0" scrolling="auto" style="width:100%;"></iframe>
       </div>
