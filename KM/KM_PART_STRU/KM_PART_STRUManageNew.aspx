...
<div class="main">
   ...
   <div class="topfind hide"><!--需要隐去时，用 style="display:none;"-->        
    ...
    <dd>
        <span><input id="btn_New" type="button" value="新建" onclick="_newRecord('tbList','KM_PART_STRUEdit.aspx');" /></span>
        <span><input id="btn_Dels" type="button" value="删除" onclick="_delBySelKeyIDS('KM_PART_STRUBack.aspx');" /></span>
    </dd></dl>
     <ul>
         ...
         <table cellpadding="0" cellspacing="0" id="tbList">
            <thead>
                <tr keyname="PART_ID">
                    ...
                    <a class="hide" href="KM_PART_STRUEdit.aspx?PART_ID={PART_ID}">编辑</a>
                    <a class="hide" href="KM_PART_STRUBack.aspx?DelPART_ID={PART_ID}">删除</a>
                    <a class="hide" href="KM_PART_STRUShow.aspx?PART_ID={PART_ID}">详细</a>
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="KM_PART_STRUEdit.aspx?PART_ID=<%#((KM_PART_STRU)Container.DataItem).PART_ID %>">编辑</a>
                    <a href="KM_PART_STRUBack.aspx?DelPART_ID=<%#((KM_PART_STRU)Container.DataItem).PART_ID %>">删除</a>
                    <a href="KM_PART_STRUShow.aspx?PART_ID=<%#((KM_PART_STRU)Container.DataItem).PART_ID %>">详细</a>
                    </td>
