...
public partial class KM_Index: AgileFrame.AppInOne.Common.BaseAdminPage
{
    ...
    {        
        if (!IsPostBack)
        {
            ...
            if (lstChnl.Count > 0)
            {
                sb.Append("<li id=\"root_0\" data=\"{id:'0',pid:'0',sc:0,name:'知识管理',ntype:''}\" class=\"root\" exp='2'><div class=\"opened root\"><b></b><em></em><a href=\"#\">知识管理</a><a href='DeptManage.aspx'>刷新</a></div>");
                sb.Append("<ul>");
            ...
            {
                sb.Append("<li id=\"root_0\" data=\"{id:'0',pid:'0',sc:0,name:'知识管理',ntype:''}\" class=\"root\"><div class='root'><b></b><em></em><a href=\"#\">知识管理</a><a href='DeptManage.aspx'>刷新</a></div></li>");
