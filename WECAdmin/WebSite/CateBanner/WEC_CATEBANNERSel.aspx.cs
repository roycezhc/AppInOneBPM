...
public partial class WEC_CATEBANNERSel : BaseAdminPage
{
    protected string showLeftLinks(string path, string pname)
    {
        ...
        if (litPathLink.Text == "")
        {
            litPathLink.Text = CommonHelper.GetPathLinks("WEC_CATEBANNERSel.aspx", pid, path, pname);
        }
        return CommonHelper.ShowLinkByPath("WEC_CATEBANNERSel.aspx", path);
    }
    ...
    protected void aspPager_PageChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            listObj = BLLTable<WEC_CATEBANNER>.SelectByPage(valObj, condObj, aspPager.PageSize, aspPager.CurrentPageIndex, ref recount);
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        //WEC_CATEBANNER valObj = BLLTable<WEC_CATEBANNER>.GetRowData(WEC_CATEBANNER.Attribute.ID, pid);
        //litPathLink.Text = CommonHelper.GetPathLinks("WEC_CATEBANNERSel.aspx", pid, valObj.PATH, valObj.PNAME);
        //a_top.Visible = true;
