<%@ Page Title="多选页面对话框" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CATEBANNERSels.aspx.cs" Inherits="WEC_CATEBANNERSels" %>
       ...
       <table cellpadding="0" cellspacing="0">
             <thead>
                <tr>
                    ...
                    <td><%=WEC_CATEBANNER.Attribute.ID._ZhName %><!--编号--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.AID._ZhName %><!--公众号编号--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.PIC_URL._ZhName %><!--图片地址--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.OUT_URL._ZhName %><!--链接地址--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.SORT_ID._ZhName %><!--排序--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.STATUS._ZhName %><!--状态--></td>
                    
                    
                    <td><%=WEC_CATEBANNER.Attribute.ADDTIME._ZhName %><!--添加时间--></td>
                </tr>
            </thead>
            <tbody>
