<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CATEBANNEREdit.aspx.cs" Inherits="WEC_CATEBANNEREdit" %>
...
<div class="form" id="divForm">
       <div>
           ...
           <dl>
               <dt><%=WEC_CATEBANNER.Attribute.NAME.ZhName %>：</dt><%--标题--%>
               <dd><span>
               <!--文字-->
