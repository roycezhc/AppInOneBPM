<%@ Page Title="用户选择" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_MODELSel.aspx.cs" Inherits="WEC_MODELSel" %>
          ...
          <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><%=WEC_MODEL.Attribute.ID._ZhName %></td><!--编号-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.TYPE._ZhName %></td><!--类型-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.PIC_URL._ZhName %></td><!--图片地址-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.PATH._ZhName %></td><!--模版路径-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.STATUS._ZhName %></td><!--状态-->
                    
                    
                    <td><%=WEC_MODEL.Attribute.NAME._ZhName %></td><!--标题-->
                </tr>
            </thead>
