...
public partial class WEC_MODELSel : BaseAdminPage
{
    protected string showLeftLinks(string path, string pname)
    {
        ...
        if (litPathLink.Text == "")
        {
            litPathLink.Text = CommonHelper.GetPathLinks("WEC_MODELSel.aspx", pid, path, pname);
        }
        return CommonHelper.ShowLinkByPath("WEC_MODELSel.aspx", path);
    }
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        //WEC_MODEL valObj = BLLTable<WEC_MODEL>.GetRowData(WEC_MODEL.Attribute.ID, pid);
        //litPathLink.Text = CommonHelper.GetPathLinks("WEC_MODELSel.aspx", pid, valObj.PATH, valObj.PNAME);
        //a_top.Visible = true;
