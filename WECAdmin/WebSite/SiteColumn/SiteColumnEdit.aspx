...
<div class="form" id="divForm">
       <div>
           ...
           <dl class="hide" >
               <dt><%=WEC_COLUMN.Attribute.ID.ZhName %>：</dt><%--编号--%>
               <dd><span>
               <!--文字-->
           ...
           <dl class="hide">
               <dt><%=WEC_COLUMN.Attribute.PID.ZhName %>：</dt><%--父编号--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.COLUMN_NAME.ZhName %>：</dt><%--栏目名称--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.COLUMN_DES.ZhName %>：</dt><%--栏目描述--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.PIC_URL.ZhName %>：</dt><%--图片地址--%>
                    <dd>
                        <div class="controls">
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.OUT_URL.ZhName %>：</dt><%--外链地址--%>
               <dd><span>
               <!--文字-->
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.UP_FLAG.ZhName %>：</dt><%--是否显示在首页--%>
               <dd><span>
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.STATUS.ZhName %>：</dt><%--状态--%>
               <dd><span>
           ...
           <dl  class="hide">
               <dt><%=WEC_COLUMN.Attribute.ADDTIME.ZhName %>：</dt><%--添加时间--%>
               <dd><span>
           ...
           <dl>
               <dt><%=WEC_COLUMN.Attribute.SORT_ID.ZhName %>：</dt><%--排序--%>
               <dd><span>
               <!--文字-->
