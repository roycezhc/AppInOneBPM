<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_ArticleEdit.aspx.cs" Inherits="WEC_ArticleEdit" %>
...
<div class="form" id="divForm">
       <div>
           ...
           <dl class="hide">
               ...
               <dd><span>
               <!--文字-->
                    <input id="txtID" type="text" runat="server" ck="{type:1,min:0,need:1}"/></span>
               </dd>
           </dl>
           <dl class="hide">
           ...
           <dl>
            ...
            <dl class="hide">
               <dt><%=WEC_Article.Attribute.ADDTIME.ZhName %>：</dt><%--添加时间--%>
               <dd><span>
               <!--文字-->
