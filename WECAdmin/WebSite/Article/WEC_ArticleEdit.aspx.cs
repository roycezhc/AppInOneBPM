...
public partial class WEC_ArticleEdit : BaseAdminPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                if (keyid != "")
                {
                    valObj = BLLTable<WEC_Article>.GetRowData(WEC_Article.Attribute.ID, keyid);
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (keyid != "")
            {
                ...
                count = BLLTable<WEC_Article>.Update(valObj, WEC_Article.Attribute.ID);
            }
            else
            {
                count = BLLTable<WEC_Article>.Insert(valObj, WEC_Article.Attribute.ID);
