...
public partial class WEC_CS_DEFAULTRESPONSEShow : BaseAdminPage
{
    protected WEC_CS_DEFAULTRESPONSE valObj=new WEC_CS_DEFAULTRESPONSE();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                {
                    valObj = BLLTable<WEC_CS_DEFAULTRESPONSE>.Factory(conn).GetRowData(WEC_CS_DEFAULTRESPONSE.Attribute.ID, Request["ID"]);
                    ...
                    txtMSGCONTENT.Text = Convert.ToString(valObj.MSGCONTENT);//Convert.ToString
