<%@ Page Title="用户选择" Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" CodeFile="WEC_CS_DEFAULTRESPONSESel.aspx.cs" Inherits="WEC_CS_DEFAULTRESPONSESel" %>
          ...
          <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.ID._ZhName %></td><!--编号-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.AID._ZhName %></td><!--公众号编号-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.ADDTIME._ZhName %></td><!--添加时间-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.STATUS._ZhName %></td><!--状态-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.STARTTIME._ZhName %></td><!--开始时间-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.ENDTIME._ZhName %></td><!--结束时间-->
                    
                    
                    <td><%=WEC_CS_DEFAULTRESPONSE.Attribute.MSGCONTENT._ZhName %></td><!--消息内容-->
                </tr>
            </thead>
