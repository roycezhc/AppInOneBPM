...
public partial class WECAdmin_ReCall_WEC_ACTIVITY_youhuiquan : System.Web.UI.Page
{
    ...
    {
        WEC_ACTIVITY conf2 = new WEC_ACTIVITY();
        open_id = HttpUtil.GetReqStrValue("open_id");
        a_id = HttpUtil.GetReqStrValue("a_id");
        conf2.ID = Convert.ToDecimal(a_id);
        activity = BLLTable<WEC_ACTIVITY>.GetRowData(new WEC_ACTIVITY(), conf2);
        ...
        else
        {
            ...
            {
                isGet = true;
                WEC_ACTIVITY_SNCODE conf3 = new WEC_ACTIVITY_SNCODE();
                conf3.SN_CODE = detail.SN_CODE;
                WEC_ACTIVITY_SNCODE sncode = BLLTable<WEC_ACTIVITY_SNCODE>.GetRowData(new WEC_ACTIVITY_SNCODE(), conf3);
