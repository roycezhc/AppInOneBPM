<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Detail2.ascx.cs" Inherits="WECWebsite_Detail_Detail2" %>
    <script type="text/javascript">

        document.write('<link rel="stylesheet" type="text/css" href="<%=preUrl %>themes/wec/template/css/detail2.css?r=' + Math.random() + '"" media="all" />');
    </script>

    <div class="body" style="padding-bottom:60px;">

			<section>
		   <img src="<%=preUrl %>Themes/WEC/img/v79_11.jpg" style="width:100%;" alt="top"/>
	</section>
	<section>
	...
	<section>
		<img src="<%=preUrl %>Themes/WEC/img/v79_13.jpg"style="width:100%;" alt="bottom" />
	</section>
