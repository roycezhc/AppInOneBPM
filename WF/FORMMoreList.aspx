<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="WF_MOREList" CodeFile="FORMMoreList.aspx.cs" %>
         ...
         <table cellpadding="0" cellspacing="0" id="tbList">
            <thead>
                <tr keyname="RECID">
                   ...
                   <th data="{colname:'<%=WF_FORMBASE.Attribute.CSTAFF_NAME.LongName%>',show:1}">提交人</th><!--创建人名-->
                   ...
                   <th data="{colname:'<%=WF_FORMBASE.Attribute.ADDTIME.LongName%>',show:1}">提交时间</th><!--录入时间-->
                   <th data="{colname:'<%=WF_FORMBASE.Attribute.CHECK_INFO.LongName%>',show:1}"><%=WF_FORMBASE.Attribute.CHECK_INFO._ZhName %></th><!--审批情况-->
                   <%=strTHS%>
                </tr>
            </thead>
            <tbody>
