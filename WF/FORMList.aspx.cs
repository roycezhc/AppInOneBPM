...
public partial class WF_MOREList:BaseAdminPage
{
    ...
    /// <summary>
    /// 这个函数有错，不如使用  StringHelper.GetCenterString(recName, "]", "2")
    /// </summary>
    ...
    private void BindList(int curPage)
    {
        ...
        if (wfobj !=null)
        {
           // condObj.WFID = wfobj.WFID_SRC;
            ...
            strWhere += " and wfbase.WFID=" + wfobj.WF_OBJ_ID;
        }
        ...
        if (!IsPostBack)
        {
           ...
           ////////////
            ...
            for (int i = 0; i < lstType.Count; i++)
            {
                ...
                {
                    litMenu.Text += "<li><a href='" + appPath + "WF/FORMList.aspx?mine=1&WFID=" + l.WF_OBJ_ID + "' data=\"{key:'wf" + l.WF_OBJ_ID + "mylist'}\">" + l.WF_OBJ_NAME + "管理</a></li>";
                }
                litMenu.Text += "</ul></li>";
            }
            ////////////
            ...
            aspPager.ShowInputBox = AgileFrame.Core.WebSystem.ShowInputBox.Auto;
