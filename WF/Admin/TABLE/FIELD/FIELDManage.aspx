...
<div class="main">
   ...
   <div class="topfind hide"><!--需要隐去时，用 style="display:none;"-->        
    ...
    <div class="titnav">
     <dl><dt><b>考勤统计数据接口配置</b></dt>
     <dd><span><asp:Button ID="btnSaveFangAn" runat="server" Text="保存接口方案" 
             onclick="btnSaveFangAn_Click" /></span></dd></dl>
    </div>
