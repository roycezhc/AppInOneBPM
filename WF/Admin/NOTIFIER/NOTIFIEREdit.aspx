<%@ Page Language="C#" MasterPageFile="~/Themes/Blank.master" AutoEventWireup="true" Inherits="WF_NOTIFIER_TPLEdit" CodeFile="NOTIFIEREdit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 ...
 <script type="text/javascript">
     $(function () {
         ...
         selTypeChg($("select[id$='txtNOTIFIER_TYPE']")[0]);
     });
...
<div class="form" id="divForm">
       <div>
           <dl>
               <dt><%=WF_NOTIFIER_TPL.Attribute.NOTIFIER_TYPE.ZhName %>：</dt><%--审批人类型--%>
               <dd><span> <select id="txtNOTIFIER_TYPE" runat="server" onchange="selTypeChg(this);" ck="{need:1,len:2,type:0}">
           ...
           <dl>
               <dt><%=WF_NOTIFIER_TPL.Attribute.STATUS.ZhName %>：</dt><%--状态--%>
               <dd><span>
