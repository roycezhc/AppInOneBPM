...
public partial class WF_NOTIFIER_TPLManage:BaseAdminPage
{

    WF_NOTIFIER_TPL valObj = new WF_NOTIFIER_TPL();
    WF_NOTIFIER_TPL condObj = new WF_NOTIFIER_TPL();
    List<WF_NOTIFIER_TPL> listObj = new List<WF_NOTIFIER_TPL>();
