 ...
 <script type="text/javascript">
     $(function () {
       ...
       function selFIELD_ID(me) {
           var result = window.showModalDialog('../../TABLE/FIELD/FIELDSel.aspx?formid=<%=formid %>&r=' + Math.random(), 'newwindow', 'dialogHeight=600px; dialogWidth=600px;dialogLeft:;dialogTop:; status=No;');if (!result) {result = window.returnValue;}//jin-shenjian chrome刷新父画面
        ...
        <input id="txtTB_ID" type="hidden" runat="server" ck="{need:0,len:9999,type:1}"/> 
           ...
           <dl>
               ...
               <dd><span>
                   ...
                   <input value="项目配置" type="button" id="btnAddItem" style="display:none;width:70px;" onclick="ctrlItemSet(this);" />
                   </span>
               </dd>
           </dl>
           <dl>
